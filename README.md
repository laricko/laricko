...
### Экспериментальные проекты или темплейты
...
Пример backend цифрового кошелька с балансами, транзакциями и базовой финансовой логикой.

- https://github.com/laricko/inventor_accounting
Пример системы учёта товаров и склада с хранением позиций, количеств и простой бухгалтерией.
