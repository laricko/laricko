...
Сейчас я развиваю свой B2B SaaS Internal Developer Platform типа проект, который позволяет командам с микросервисной архитектурой легко управлять своими сервисами, автоматизировать процессы и улучшать взаимодействие между командами. Ссылки нет, репозиторий приватный.
...
- https://github.com/laricko/organization-catalog
Простой сервис для хранения Организаций - Адресов - Деятельности. С возможностью фильтрации по геопозиции.
